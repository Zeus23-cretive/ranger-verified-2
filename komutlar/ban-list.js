    ...
    userlist.then(collection => {
        if (collection.first() == null) {
            const embed = new Discord.MessageEmbed()
                .setTitle(`<:Tatli:777218012537159730> Banlanan Kullanıcı bulunamadı <:Tatli:777218012537159730>`)
                .setColor("RED");
            message.channel.send({ embed });
        }
        else {
            const embed = new Discord.MessageEmbed()
                .setTitle("<a:ban:775685683519029250> Ban Listesi: Sunucudan Banlananlar.")
                .setColor("RED");
