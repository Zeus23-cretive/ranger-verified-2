...
exports.run = async (client, message, args) => {
    if (message.author.id !== message.guild.owner.user.id) return message.channel.send('Yeterli Yetkiye Sahip Görünmüyorsun! ' + client.emojis.cache.get('647760202875142154'))
...
n!banözelliği Yazıp Kullanımını Detaylıca Öğreniniz Yoksa bir İşe Yaramaz!
`);
};
